...
class DetailActivity : AppCompatActivity() {
    ...
    // La opción del menú de favorito para poder cambiar el icono
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // Obtenemos el parámetro del horóscopo que queremos visualizar
        ...
        // habilitamos el botón de volver atrás en el ActionBar
        supportActionBar?.setDisplayHomeAsUpEnabled(true)

        // Instanciamos el objeto de la sesión
        session = SessionManager(this)

        // Revisamos si el horoscopo es favorito
        isFavorite = session.isFavorite(horoscope.id)

        // Busco los componentes visuales
    ...
    // Funciona para capturar que opción del menú se ha clickeado
