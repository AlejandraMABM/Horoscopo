...
class HoroscopeAdapters(var items: List<Horoscope>, val onItemClick: (Int) -> Unit) : RecyclerView.Adapter<HoroscopeViewHolder>(){
    ...
    // Función para actualizar la lista de itmes y refrescar las celdas
...
class  HoroscopeViewHolder (view:View) : RecyclerView.ViewHolder(view) {
    ...
    fun render(horoscope: Horoscope) {
       ...
       // symbolImageView.setImageDrawable(context.getDrawable(horoscope.image))
        ...
        // Si es favorito mostramos el corazón, si no lo escondemos
